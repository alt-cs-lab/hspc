...
*/
const EVENT_STATUS_UNPUBLISHED = 1;
const EVENT_STATUS_REGISTERABLE = 2;
const EVENT_STATUS_ACTIVE = 3;
const EVENT_STATUS_ARCHIVED = 4;
const eventStatuses = [EVENT_STATUS_UNPUBLISHED, EVENT_STATUS_REGISTERABLE, EVENT_STATUS_ACTIVE, EVENT_STATUS_ARCHIVED];
...
module.exports = {
    ...
    advisorStatuses,
    EVENT_STATUS_UNPUBLISHED,
    EVENT_STATUS_REGISTERABLE,
    EVENT_STATUS_ACTIVE,
