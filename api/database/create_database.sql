...
DROP TABLE IF EXISTS AdvisorStatus CASCADE;
...
CREATE TABLE SchoolAdvisors (
	...
	UserID INT,
	SchoolID INT,
	AdvisorStatusID SMALLINT,
	PRIMARY KEY (AdvisorID),
	FOREIGN KEY (UserID) REFERENCES Users(UserID),
	FOREIGN KEY (SchoolID) REFERENCES Schools(SchoolID),
	FOREIGN KEY (AdvisorStatusID) REFERENCES AdvisorStatus(StatusID),
