...
class ViewUsers extends Component {
  ...
  RoleFilter(role) {
    ...
    for (let i = 0; i < allUsers.length; i++) {
      if (
        activeRoles !== 0 &&
        (activeRoles & roleTable[allUsers[i].Role]) > 0
      ) {
      ...
      <div id="student-data-table">
        ...
        >
          ...
          >
            ...
            <FormCheck
              onChange={() => {
                this.RoleFilter(constants.VOLUNTEER);
              }}
            />
          </div>
          <div
          ...
          >
            ...
            <FormCheck
              onChange={() => {
                this.RoleFilter(constants.JUDGE);
              }}
            />
          </div>
          <div
          ...
          >
            ...
            <FormCheck
              onChange={() => {
                this.RoleFilter(constants.ADVISOR);
              }}
            />
          </div>
          <div
          ...
          >
            ...
            <FormCheck
              onChange={() => {
                this.RoleFilter(constants.ADMIN);
              }}
            />
          </div>
        </div>
