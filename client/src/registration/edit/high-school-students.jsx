...
class EditStudent extends Component {
  ...
  componentDidMount = () => {
    ...
    this.setState({ gradYear: dateArray[0], gradMonth: constants.months[dateMonth - 1]});
  };
        ...
        <Form onSubmit={(event) => this.editStudent(event)}>
          <div class="add-margin">
            ...
            <Form.Group className="mb-3">
              ...
              <Select options={ this.state.schoolList }
                onChange={(target => this.setState({ studentSchool: target, schoolId: target.value }))} value={ this.state.studentSchool[0] }/>
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Email</Form.Label>
              <Form.Control disabled type="email" required placeholder="Ex: devangriffin@email.com" 
            ...
            <Form.Group className="mb-3">
              ...
              <Select placeholder="Select a Month" options={ constants.months } 
                  onChange={( target => this.setState({ gradMonth: target }))} value={ this.state.gradMonth }/>
            </Form.Group>
