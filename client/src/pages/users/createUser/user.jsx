...
import { registerUser } from "../../../_store/actions/authActions.js";
import UserService from "../../../_common/services/user.js"; //added so students can bee created at the same time they are made into users Natalie Laughlin
import {
  SET_SCHOOL_DROPDOWN_REQUIRED,
} from "../../../_store/actions/types.js";
