...
export default function Home() {
  ...
  useEffect(() => {
    EventService.getHighlightEvent()
      ...
      .catch((resErr) =>
        console.log("There was an error while retrieving events\n", resErr)
      );
  }, []);
      ...
      <div className="banner">
        ...
        {highlightEvent !== null ? (
          <div id="back-layout">
            ...
            <h2 id="header">
              {constants.dateFormat(highlightEvent.eventdate)} @{" "}
              {constants.timeFormat(highlightEvent.eventstarttime)} -{" "}
              {constants.timeFormat(highlightEvent.eventendtime)}
            </h2>
