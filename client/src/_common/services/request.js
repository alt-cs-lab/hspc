...
class RequestService {
    ...
    */
    completeSchoolRequest( approved, schoolid, advisorid ) {
        return ServiceUtils.postRequest('/api/request/completeSchool', {approved: approved, schoolid: schoolid, advisorid: advisorid});
    }
    ...
    */
    requestAdditionalSchool( schoolid, advisorid ) {
        return ServiceUtils.postRequest('/api/request/requestSchool', {schoolid: schoolid, advisorid: advisorid});
    }
}
